...
const ItemPopout = () => {
  ...
  return <motion.aside
    ...
    onClick={() => dispatch(toggleVisibility())}
      ...
      animate={isVisible ? {opacity: 1, display: "block"} : {opacity: 0, zIndex: 0, display: "none"}}
      exit={{opacity: 0, display: "none"}}
    >
    <motion.div className={styles.container}
    onClick={() => dispatch(toggleVisibility())}
      transition={{type: "tween"}}
      initial={{opacity: 0, x: "50vw", display: "none"}}
      animate={isVisible ? {opacity: 1, x: 0, display: "block"} : {opacity: 0, zIndex: 0, x: "50vw", display: "none"}}
      exit={{opacity: 0, x: "50vw", display: "none"}}
    >
    ...
    onClick={() => dispatch(toggleVisibility())}
      transition={{type: "tween"}}
      initial={{opacity: 0, x: "50vw", display: "none"}}
      animate={isVisible ? {opacity: 1, x: 0, display: "flex"} : {opacity: 0, zIndex: 0, x: "50vw", display: "none"}}
      exit={{opacity: 0, x: "50vw", display: "none"}}
    >
